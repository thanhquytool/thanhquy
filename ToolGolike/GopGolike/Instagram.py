...
def INSTAGRAM():
    ...
    for data in checkurl1_2['data'] :
        ...
        print(f'\033[1;36m[{i}] \033[1;97mTài Khoản┊\033[1;32m㊪ :\033[1;93m {usernametk} \033[1;97m|\033[1;32m㊪ :\033[1;93m {STATUS[-1]}')
       
        i += 1
    print('\033[97m════════════════════════════════════════════════')
    choose = int(input('\033[1;32m>\033[1;31m>\033[1;33m> \033[1;36mNhập Tài Khoản: \033[1;37m'))
    ...
    if choose >=1 or choose <= len(user_INS) :
        ...
        checkfile2 = os.path.isfile('CookieIG'+str(account_id)+'.txt')
        if checkfile2 == False:
            banner()
            cookieX = input(Fore.GREEN+'\033[1;32m>\033[1;31m>\033[1;33m> \033[1;36mNhập Cookie Instagram: \033[1;37m')
            createfile = open('CookieIG'+str(account_id)+'.txt','w')
            createfile.write(cookieX)
            createfile.close()
            readfile = open('CookieIG'+str(account_id)+'.txt','r')
        ...
        os.system('cls' if os.name== 'nt' else 'clear')
        banner()
        choose = int(input(Fore.RED+'\033[1;32m>\033[1;31m>\033[1;33m> \033[1;36mNhập Số Lượng Job: \033[1;37m'))
        headerINS = {
                'accept': '*/*',
        ...
        DELAY = int(input(Fore.RED+'\033[1;32m>\033[1;31m>\033[1;33m> \033[1;36mNhập Delay: \033[1;37m'))
        os.system('cls' if os.name== 'nt' else 'clear')
        banner()
                ...
                if nos['status'] == 200:
                    ...
                    if job_type == 'follow':
                        ...
                        if '"status":"ok"' in response:
                            ...
                            os.remove(f'CookieIG{account_id}.txt')
                            return 0
...
\033[1;37m══════════════════════════════════════════════════════════════
\033[1;97m[\033[1;91m📝\033[1;97m]\033[1;97m Tool\033[1;31m     : \033[1;31m☞ Golike - Instagram🧸 ☜
...
print(Fore.GREEN+'\033[1;97m[\033[1;91m📌\033[1;97m]\033[1;32mTài Khoản : '+Fore.YELLOW+username)
print(Fore.GREEN+'\033[1;97m[\033[1;91m📌\033[1;97m]\033[1;32mTổng Tiền : '+Fore.YELLOW+str(coin))
