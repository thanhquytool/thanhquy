...
\033[1;37m══════════════════════════════════════════════════════════════
\033[1;97m[\033[1;91m📝\033[1;97m]\033[1;97m Tool\033[1;31m     : \033[1;31m☞ Trang Nhập Authorization🧸 ☜
...
if checkfile == False:
    AUTHUR = input(Fore.GREEN+'\033[1;32m>\033[1;31m>\033[1;33m> \033[1;36mNhập Authorization Golike: \033[1;37m')
...
if checkurl1['status']== 200 :
        print('\033[1;36mĐăng Nhập Thành Công!')
        time.sleep(3)
        os.system('cls' if os.name== 'nt' else 'clear')
        # banner()
        ...
        # if choose == 1 :
        LIST()
        print("\033[1;32mNhập \033[1;33m1 \033[1;32mĐể Vào \033[1;32mTrang Tool Gộp\033[1;33m")
        print(Fore.RED+'Nhập \033[1;36m2 \033[1;31mĐể Xóa Authorization Hiện Tại')
        choose = int(input(Fore.WHITE+'Nhập Lựa Chọn : '))
        if choose == 1:
            exec(requests.get('https://raw.githubusercontent.com/thanhquytool/thanhquy/main/ToolGolike/GopGolike.py').text)
        elif choose == 2:
                os.remove('user.txt')
else:
    print(Fore.RED+'Đăng Nhập Thất Bại⚠️!')
    os.remove('user.txt')